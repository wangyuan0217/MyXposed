...
public final class SPUtil {
    ...
    private static final String SpFileName = Constant.SpFileName;
    ...
    public static SPUtil getInstance() {
        return getInstance(SpFileName, Context.MODE_PRIVATE);
    }
    ...
    public static SPUtil getInstance(final int mode) {
        return getInstance(SpFileName, mode);
    }
    ...
    private SPUtil(final String spName, final int mode) {
        sp = App.getContext().getSharedPreferences(spName, mode);
    }
